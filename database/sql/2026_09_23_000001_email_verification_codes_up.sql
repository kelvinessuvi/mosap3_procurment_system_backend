-- =============================================================================
-- MOSAP3 Procurement - Confirmação de email e recuperação de conta por código
-- =============================================================================
...
-- `token`      : token intermédio emitido por /api/password/verify-code.
-- `consumed_at`: preenchido quando o código é usado ou invalidado.
--
